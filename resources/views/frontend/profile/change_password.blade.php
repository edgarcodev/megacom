...
<div class="body-content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <h3 class="text-center"><span class="text-danger">Cambiar Contraseña </span><strong></strong>
                    
                    </h3><br>
                    <div class="card-body">
                        <form method="post" actiont="{{ route('user.password.update') }}"  enctype="multipart/form-data">
                            @csrf
